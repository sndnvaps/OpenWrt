...
# 修改默认IP
 sed -i 's/192.168.1.1/192.168.13.111/g' package/base-files/files/bin/config_generate
...
sed -i "s/${orig_version}/R${date_version} by sndnvaps/g" package/lean/default-settings/files/zzz-default-settings
